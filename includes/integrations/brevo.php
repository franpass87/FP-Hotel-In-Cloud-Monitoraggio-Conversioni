...
function hic_dispatch_brevo_reservation($data, $is_enrichment = false, $gclid = '', $fbclid = '', $msclkid = '', $ttclid = '') {
  ...
  $attributes = array(
    ...
    'HIC_ACCOM_ID' => isset($data['accommodation_id']) ? $data['accommodation_id'] : '',
    'HIC_ROOM_ID' => isset($data['room_id']) ? $data['room_id'] : '',
    'HIC_OFFER' => isset($data['offer']) ? $data['offer'] : '',
...
function hic_send_brevo_reservation_created_event($data, $gclid = '', $fbclid = '', $msclkid = '', $ttclid = '') {
  ...
  $body = array(
    ...
    'properties' => array(
      ...
      'accommodation_id' => isset($data['accommodation_id']) ? $data['accommodation_id'] : '',
